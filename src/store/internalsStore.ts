...
import { useLangStore } from './simulationStore'
...
export interface InternalsState {
...
export type { Lang } from './simulationStore'

export const STEP_PROCESS_LABEL: Record<string, Partial<Record<SimulationStep, string>>> = {
  ko: {
...
const initialState: InternalsState = {
  currentStep: 'idle',
  query: '',
  isRunning: false,
  isComplete: false,
...
export const useInternalsStore = create<InternalsState & InternalsActions>((set, get) => ({
  ...initialState,
