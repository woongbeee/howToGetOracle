...
export const TABLE_STATS: Record<string, TableStats> = {
  ...
  EMPLOYEES: {
    ...
    avgRowLen: 70,
    columns: [
      { columnName: 'EMPLOYEE_ID',   ndv: 107, nullCount: 0, low: 100, high: 206, hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: true },
      { columnName: 'FIRST_NAME',    ndv: 91,  nullCount: 1, low: 0,   high: 91,  hasIndex: false, isIndexLeadingCol: false, isPrimaryKey: false },
      { columnName: 'LAST_NAME',     ndv: 102, nullCount: 0, low: 0,   high: 102, hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: false },
      { columnName: 'EMAIL',         ndv: 107, nullCount: 0, low: 0,   high: 107, hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: false },
      { columnName: 'SALARY',        ndv: 58,  nullCount: 0, low: 2100,high: 24000,hasIndex: false, isIndexLeadingCol: false, isPrimaryKey: false },
      { columnName: 'DEPARTMENT_ID', ndv: 11,  nullCount: 1, low: 10,  high: 110, hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: false },
      { columnName: 'JOB_ID',        ndv: 19,  nullCount: 0, low: 0,   high: 19,  hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: false },
      { columnName: 'MANAGER_ID',    ndv: 18,  nullCount: 1, low: 100, high: 205, hasIndex: true,  isIndexLeadingCol: true,  isPrimaryKey: false },
    ],
  },
  JOB_HISTORY: {
